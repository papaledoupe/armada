...
function module:passage_main()
    coroutine.yield("talk", {text = self:processVars("value: {my.accessor}"), attributes = {}})
    self:setVar("my.accessor", 1)
    coroutine.yield("talk", {text = self:processVars("value: {my.accessor}"), attributes = {}})
    self:setVar("my.accessor", true)
    coroutine.yield("talk", {text = self:processVars("value: {my.accessor}"), attributes = {}})
    self:setVar("my.accessor", "str")
    coroutine.yield("talk", {text = self:processVars("value: {my.accessor}"), attributes = {}})
end
